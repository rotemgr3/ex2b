...
bool testErrorNames(){
    ...
    ASSERT_ERROR_WITH_MESSAGE(testGame.move(GridPoint(1,1), GridPoint(1,1)), mtm::CellOccupied, "A game related error has occurred: CellOccupied");
    ...
    ASSERT_ERROR_WITH_MESSAGE(testGame.attack(GridPoint(3,1), GridPoint(3,1)), mtm::IllegalTarget, "A game related error has occurred: IllegalTarget");
...
bool testGame2(){
    ...
    ASSERT_ERROR(g1.attack(GridPoint(4,6), GridPoint(4,6)), mtm::IllegalTarget);
    ASSERT_ERROR(g1.attack(GridPoint(3,3), GridPoint(3,6)), OutOfAmmo);
    ASSERT_NO_ERROR(g1.reload(GridPoint(3,3)));
    ASSERT_NO_ERROR(g1.reload(GridPoint(3,3)));
    ASSERT_NO_ERROR(g1.attack(GridPoint(3,3), GridPoint(3,6)));
